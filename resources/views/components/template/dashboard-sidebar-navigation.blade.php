<section class="h-full w-[280px] flex-shrink-0 flex-col justify-between overflow-y-auto bg-theme-300">
    <nav class="space-y-8">
        ...
        <div class="space-y-4" aria-label="sidebar-section-with-label">
            <h3 class="text-xs text-theme-accent uppercase leading-4 font-semibold px-11"> Elements </h3>
